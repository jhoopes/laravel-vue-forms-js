...
export default defineComponent({
  ...
  setup() {
    ...
    provide("lvfApiClient", apiClient);
    provide("lvfUseJsonApi", true);
    provide("lvfStore", store);
...
<template>
  <div id="app" class="flex flex-wrap bg-gray-200 w-full h-screen">
    <div class="w-2/12 bg-white rounded p-3 shadow-lg">
      <div class="flex items-center space-x-4 p-2 mb-5">
        ...
        <div>
          ...
          <div class="text-sm tracking-wide flex items-center space-x-1 mb-2">
            <div v-if="hasAuth">
            ...
            <div v-else class="text-center">
              ...
              <button class="button p-1" @click="setUpSession">
                Get Login Session
              </button>
            </div>
          </div>
          <button class="button p-1" @click="getUser">Get User</button>
        </div>
      </div>
      <ul class="space-y-2 text-sm">
        ...
        <li>
          <router-link to="/entity_types" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:shadow-outline" active-class="bg-gray-200">
                    <span class="text-gray-600">
                        <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
        ...
        <li>
          <router-link to="/forms" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:shadow-outline" active-class="bg-gray-200">
                    <span class="text-gray-600">
                        <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
        ...
        <li>
          <router-link to="/entities" class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:shadow-outline" active-class="bg-gray-200">
                    <span class="text-gray-600">
                        <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
    ...
    <div class="w-9/12">
      ...
      <router-view class="p-2 mx-2"></router-view>
    </div>
  </div>
</template>
