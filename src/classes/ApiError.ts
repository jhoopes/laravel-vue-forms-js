...
const parseValidationErrors = (responseData: Record<string, any> | string): Collection<ValidationErrorMessage> => {

    let validationErrors = new Collection([], {
