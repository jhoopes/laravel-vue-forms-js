  ...
  implements ITypedCollection<MT>
{
  ...
  add(model: MT | MT[] | Record<string, any>): void {
    ...
    const updatedModels = this.getModels();
    updatedModels.push(model as MT);
    this.models = []; // TODO: Force reactivity here, but find a better way
  ...
  dataIsPaginated(
    ...
    return (
      data.current_page !== null && typeof data.current_page !== "undefined"
    );
  }
