    ...
    export default {
        ...
        computed: {
            standardValidationRules() {
                var standardOptions = JSON.parse(JSON.stringify(this.$store.state.form_admin.standardValidationRules));
            ...
            selectedStandardValidationRule() {
                ...
                if(!this.rule || !this.internalRuleParts || !this.internalRuleParts.value) {
                    return null;
                }
            ...
            hasOptions() {
                ...
                return this.selectedStandardValidationRule.options && this.selectedStandardValidationRule.options.length > 0;
            },
            ruleOptions() {
                if(!this.hasOptions) {
                    return [];
                ...
                return this.selectedStandardValidationRule.options.map(function(optionName) {
                    return {
                        title: optionName,
        ...
        methods: {
            ...
            updateInternalRuleParts() {
                ...
                let stdValidationRuleType = this.$store.state.form_admin.standardValidationRules.filter({value: ruleValue}).first();
